...
(defmacro gruvbox-deftheme (name description palette &rest body)
  `(autothemer-deftheme
    ...
    ((default                                   (:background gruvbox-bg :foreground gruvbox-light1))
     ...
     (org-level-1                               (:foreground gruvbox-bright_blue :bold gruvbox-bold-constructs))
     (org-level-2                               (:foreground gruvbox-bright_yellow :bold gruvbox-bold-constructs))
     (org-level-3                               (:foreground gruvbox-bright_purple :bold gruvbox-bold-constructs))
     (org-level-4                               (:foreground gruvbox-bright_red :bold gruvbox-bold-constructs))
     (org-level-5                               (:foreground gruvbox-bright_green :bold gruvbox-bold-constructs))
     (org-level-6                               (:foreground gruvbox-bright_aqua :bold gruvbox-bold-constructs))
     (org-level-7                               (:foreground gruvbox-faded_blue :bold gruvbox-bold-constructs))
     (org-level-8                               (:foreground gruvbox-bright_orange :bold gruvbox-bold-constructs))
